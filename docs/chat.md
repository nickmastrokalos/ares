...
- **TAK Server / SSL streaming** — the Rust `send_tcp` stub returns "not supported yet". Adding this means a persistent connection manager and (eventually) PEM/PKCS12 cert handling.
