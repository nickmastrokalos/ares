...
| `perimeter-halos` | `perimeter-halos-circle` | One point per breached intruder. Stroke-only red circle radius 22 px (matches the manual-track selection ring so it wraps rectangular MIL-STD-2525 icons without clipping), no fill. |
